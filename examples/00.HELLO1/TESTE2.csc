...
<simconf>
  ...
  <simulation>
    ...
    <radiomedium>
      ...
      <success_ratio_tx>0.80</success_ratio_tx>
      <success_ratio_rx>0.80</success_ratio_rx>
    </radiomedium>
    <events>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/00.HELLO1/hello-world.c</source>
      <commands EXPORT="discard">make hello-world.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/00.HELLO1/hello-world.sky</firmware>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.690709410909089 0.0 0.0 4.690709410909089 51.23083701527276 115.5333985280001</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>
