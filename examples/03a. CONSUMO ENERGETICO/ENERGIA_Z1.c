...
static uint8_t _Dist = 35;
static uint8_t _R = 250; //TMOTE SKY

//VARIAVEIS DO Z1 ZOLERTIA (mA)
static double voltage = 3.6; //Volts
static double tx =  0.0174*1000;
static double rx = 0.0188*1000;
static double cpu = 0.0000001*1000;
static double cpu_stand = 0.0000006*1000;
